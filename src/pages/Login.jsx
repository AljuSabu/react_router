  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-10 md:pt-0 lg:pt-30 xl:pt-20">
        <div className="w-full md:max-w-md lg:max-w-sm xl:max-w-md 2xl:max-w-xl bg-slate-900 p-6 md:p-10 lg:p-8 xl:p-10 rounded-3xl border border-white/10 space-y-5 md:space-y-10 lg:space-y-7 xl:space-y-10">
