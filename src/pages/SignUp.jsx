    ...
    <>
      ...
      <PageTransition>
        <div className="min-h-screen flex items-center justify-center px-6 pt-20 md:pt-0 lg:pt-24 xl:pt-20">
          <div className="w-full md:max-w-md xl:max-w-lg 2xl:max-w-xl bg-linear-to-br from-slate-900 via-black to-slate-900 p-6 md:p-10 lg:p-8 xl:p-10 rounded-3xl border border-white/10 space-y-3 md:space-y-8 lg:space-y-5 xl:space-y-8">
