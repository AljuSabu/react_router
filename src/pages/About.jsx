            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 text-slate-300 leading-relaxed">
              <div className="space-y-4">
                ...
                <p className="text-xs md:text-base">
                  ...
                  vehicle should be as exhilarating as driving one. We curate
                  only the most exceptional machines, from roaring internal
                  combustion classics to the silent, lightning-fast electric
