...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full z-50 backdrop-blur-2xl border-b border-white/30 shadow-sm shadow-black/40 p-4">
      <div className="container text-xs md:text-base xl:text-lg flex justify-between h-15 lg:h-13 xl:h-15 mx-auto">
        ...
        <div
          className={`fixed top-20 right-0 z-50 w-full text-white font-medium flex flex-col items-center gap-6 py-6 transform transition-all duration-300 ease-in-out ${
            showLinks
              ? "translate-x-0 opacity-100 blur-none bg-linear-to-br from-slate-900/95 via-black/95 to-slate-900/95 pointer-events-auto visible"
              : "translate-x-full opacity-0 invisible pointer-events-none"
          } lg:static lg:translate-x-0 lg:visible lg:pointer-events-auto lg:opacity-100 lg:blur-none lg:py-0 lg:flex-row lg:w-auto lg:bg-transparent`}
        >
          <NavLink
            to="/"
